...
// I considered managing the form's state in Redux, but decided that it's state isn't relative outside the
// form itself and could remain local. It would be easy to change this by adding actions/reducers to the form module.
